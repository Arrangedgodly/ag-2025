...
function DockItem({
  ...
  return (
    <motion.div
      ...
      className={
        (theme == 0
          ? `relative inline-flex items-center justify-center rounded-full bg-stone-700 text-stone-100 border-neutral-700 border-2 shadow-md ${className}`
          : `relative inline-flex items-center justify-center rounded-full bg-stone-700 text-stone-500 border-neutral-700 border-2 shadow-md ${className}`)
      }
      tabIndex={0}
      role="button"
      aria-haspopup="true"
